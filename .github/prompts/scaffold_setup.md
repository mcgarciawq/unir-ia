# Prompt: Professional Scaffolding

"Execute Phase 1.2 and 1.3 of `.github/plans/plan-1.md`. 
...
Follow all instructions in `.github/instructions/`. Stop after creating the structure and wait for OK to continue to the next steps in `.github/plans/plan-1.md`"